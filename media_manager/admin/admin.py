...
class Admin:
    ...
    # perform_assertions
    def __perform_assertions(self, a_name, a_email):
        # a_name
    ...
    # constructor
    def __init__(self, a_name, a_email):
        # performing asserts on parameters
        self.__perform_assertions(a_name, a_email)
    ...
    def notify_admin(self, verbose: bool, channel: E_Channel, excep: Exception, logger: Logging) -> None:
        ...
        assert type(excep) == Exception, "excep must be an Exception instance."
        ...
        if channel == E_Channel.email:
            ...
            se = MailHandling()
            se.send_email(message=message, receiver_email=self.__a_email,
